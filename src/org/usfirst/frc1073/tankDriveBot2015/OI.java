...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("extendClaws", new extendClaws());

        SmartDashboard.putData("retractClaws", new retractClaws());

        SmartDashboard.putData("extendHooks", new extendHooks());

        SmartDashboard.putData("retractHooks", new retractHooks());
